...
# Buckets: model and images are in DIFFERENT buckets
MODEL_GCS_BUCKET_NAME = "dino-model"
MODEL_GCS_PREFIX = "dino_v2_serving_package/model_artifacts"

IMAGES_GCS_BUCKET_NAME = "my_dino_test"  # images bucket
IMAGES_GCS_PREFIX = ""                        # optional subfolder (e.g., "train/")

OUTPUT_GCS_BUCKET_NAME = "dino-model"
OUTPUT_GCS_PREFIX = "dino_v2_finetuned_on_custom_data_full"

LOCAL_MODEL_PATH = tempfile.mkdtemp()
LOCAL_IMAGES_DIR = tempfile.mkdtemp()
LOCAL_OUTPUT_DIR = tempfile.mkdtemp()

PROJECTION_HEAD_OUT_DIM = 16384
TRAINING_EPOCHS = 10
PER_DEVICE_BATCH_SIZE = 8  # your current single-image test
LEARNING_RATE = 1e-4
WEIGHT_DECAY = 0.04
