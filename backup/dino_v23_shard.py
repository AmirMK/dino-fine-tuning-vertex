...
def load_data_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "OUTPUT_GCS_PREFIX": os.environ.get("OUTPUT_GCS_PREFIX", "dino_v23_shard_finetuned_on_custom_data_full"),
    }
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--per_device_batch_size", type=int, default=16) #8
    p.add_argument("--learning_rate", type=float, default=1e-4)
    p.add_argument("--weight_decay", type=float, default=0.04)
    p.add_argument("--gradient_accumulation_steps", type=int, default=2) #4
...
def main():
    try:
        ...
        DATASET_SIZE = 35000  # for now, or count your WebDataset samples dynamically
