...
def load_data_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "IMAGES_GCS_PREFIX": os.environ.get("IMAGES_GCS_PREFIX", "my_dino_shard_test"),
        "OUTPUT_GCS_BUCKET_NAME": os.environ.get("OUTPUT_GCS_BUCKET_NAME", "dino-model"),
        "OUTPUT_GCS_PREFIX": os.environ.get("OUTPUT_GCS_PREFIX", "dino_v12_shard_finetuned_on_custom_data_full"),
    }
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--datasize", type=int, default=3500) 
...
def main():
    try:
        ...
        DATASET_SIZE = args.datasize #3500  # for now, or count your WebDataset samples dynamically
        ...
        training_args = TrainingArguments(
            ...
            dataloader_num_workers=min(int(os.cpu_count() * 0.75), len(shard_paths)),
